...
class CON_model(CLIP):
    ...
    #
    def forward(self, clip_i,x_i, x_j,y_i):

       #加载模型
        z_i, z_j, z_i_patch, z_j_patch, h_i, h_j, h_i_patch, h_j_patch,clip_i=self.model(clip_i,x_i, x_j)
       ...
       # clip 处理
        ...
        return z_i, z_j, z_i_patch, z_j_patch, h_i, h_j, h_i_patch, h_j_patch,logits_per_image, logits_per_text,clip_i
